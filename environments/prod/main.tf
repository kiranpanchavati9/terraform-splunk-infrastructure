...
module "route53_prod" {
  ...
  records = {
    "cluster-manager.prod.kiranpanchavati.online" = module.splunk_ec2.instance_public_ips["cluster_master"]
    "deployer.prod.kiranpanchavati.online"        = module.splunk_ec2.instance_public_ips["deployer"]
    ...
    "license-master.prod.kiranpanchavati.online"    = module.splunk_ec2.instance_public_ips["license_master"]
